    ...
    <div id="main" className="alt">
      <section id="one">
        <div className="inner">
          ...
          <h2 id="content">Easter Egg</h2>
          <p>
            I am horrible at CSS so I've left the following sample uses from the
            template so I can refer to them at a later date. I could hide this
            but I don't think there's a big problem with this being visible, and
            I'm likely to remove it at a future date. For the moment, you can
            have a laugh that I still have it up and you found it.
          </p>
